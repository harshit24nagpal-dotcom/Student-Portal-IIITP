    ...
    <>
      <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-md border-b border-slate-200 px-6 py-3.5 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-slate-900 rounded-xl border border-slate-800 text-amber-400 shadow-sm">
            <Shield className="w-5 h-5" />
          </div>
          <div>
            <h1 className="font-black text-sm tracking-tight text-slate-900 leading-none">IIIT PUNE</h1>
            <p className="text-[10px] text-blue-800 tracking-widest uppercase font-bold mt-0.5">CAMPUS CONNECT</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 border border-slate-200 text-xs font-bold rounded-xl text-slate-700 hover:bg-slate-200/80 transition-colors cursor-pointer"
            >
            ...
            {showDemoDropdown && (
              <div className="absolute right-0 mt-2 w-56 bg-white border border-slate-200 rounded-xl shadow-xl py-1 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                <p className="text-[10px] text-slate-400 font-extrabold uppercase px-3 py-1.5 border-b border-slate-100">
                  Select System Role
                </p>
                <button
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-red-600 hover:bg-red-700 text-white text-xs font-black uppercase rounded-xl tracking-wider shadow-md flex items-center gap-1.5 cursor-pointer animate-pulse"
          >
          ...
          <div className="flex items-center gap-2 border-l border-slate-200 pl-3 sm:pl-4">
            <div className="text-right hidden sm:block">
              ...
              <span className={`inline-block text-[9px] font-extrabold uppercase px-2 py-0.5 rounded-full border mt-0.5 ${getRoleColor(user.role)}`}>
                {user.role}
              </span>
            </div>
            <div className="w-8 h-8 rounded-full bg-slate-900 text-amber-400 font-extrabold text-xs flex items-center justify-center uppercase shadow-sm">
